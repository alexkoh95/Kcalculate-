...
const FoodCard = ({ name, calories, carbohydrates, protein, fats, weight, date, mealtype }) => {
    ...
    return (
        <div className='bg-white py-2 px-2 text-xs text-gray-700 flex grid grid-cols-5 rounded-md hover:bg-opacity-50 cursor-default m-3 divide-x bg-opacity-40 shadow-lg transform hover:scale-105 transition duration-500 ease-in-out hover:animate-pulse'>
